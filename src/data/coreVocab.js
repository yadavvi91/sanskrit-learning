...
const COMMON_NOUNS = {
  ...
  // ── Top-N stems that drove generic "-म् ending — ambiguous" hits ──
  // Adding the bare stem lets the suffix-fallback produce a real gloss
  // instead of the unhelpful template.
  'महती':           { category: 'adjective', root: 'महत्', gender: 'f', gloss: 'great (f., adjective stem)' },
  'महतीम्':         { category: 'adjective', root: 'महत्', gender: 'f', number: 'eka', case: 'dvi', gloss: 'great (f., object form)' },
  'व्यूढ':          { category: 'krdanta', kind: 'past-passive', root: 'वि + √व्यह्/√ऊह्', gloss: 'drawn-up / arranged-in-formation (compound stem)' },
  'व्यूढम्':        { category: 'krdanta', kind: 'past-passive', root: 'वि + √व्यह्/√ऊह्', gender: 'n', number: 'eka', case: 'pra', gloss: 'drawn-up / arranged-in-battle-formation' },
  'व्यूढाम्':       { category: 'krdanta', kind: 'past-passive', root: 'वि + √व्यह्/√ऊह्', gender: 'f', number: 'eka', case: 'dvi', gloss: 'drawn-up / arranged-in-battle-formation (f., object)' },
  'व्यूढा':         { category: 'krdanta', kind: 'past-passive', root: 'वि + √व्यह्/√ऊह्', gender: 'f', number: 'eka', case: 'pra', gloss: 'drawn-up (f.)' },
  'भाव':            { category: 'noun', root: 'भाव', gender: 'm', gloss: 'state of being / feeling / nature (compound stem)' },
  'भावम्':          { category: 'noun', root: 'भाव', gender: 'm', number: 'eka', case: 'dvi', gloss: 'state of being / feeling (object)' },
  'भावः':           { category: 'noun', root: 'भाव', gender: 'm', number: 'eka', case: 'pra', gloss: 'state of being / feeling' },
  'पद':             { category: 'noun', root: 'पद', gender: 'n', gloss: 'foot / word / place / step (compound stem)' },
  'पदम्':           { category: 'noun', root: 'पद', gender: 'n', number: 'eka', case: 'pra', gloss: 'foot / word / place / step' },
  'अज':             { category: 'adjective', root: 'अज', gloss: 'unborn (compound stem; epithet of the आत्मन्)' },
  'अजम्':           { category: 'adjective', root: 'अज', gender: 'n', number: 'eka', case: 'pra', gloss: 'unborn (Gītā 2.20)' },
  'अजः':            { category: 'adjective', root: 'अज', gender: 'm', number: 'eka', case: 'pra', gloss: 'unborn' },
  'शौच':            { category: 'noun', root: 'शौच', gender: 'n', gloss: 'purity / cleanliness (compound stem)' },
  'शौचम्':          { category: 'noun', root: 'शौच', gender: 'n', number: 'eka', case: 'pra', gloss: 'purity / cleanliness' },
  'कृत्स्न':         { category: 'adjective', root: 'कृत्स्न', gloss: 'whole / entire (compound stem)' },
  'कृत्स्नम्':       { category: 'adjective', root: 'कृत्स्न', gender: 'n', number: 'eka', case: 'pra', gloss: 'whole / entire' },
  'अनादि':          { category: 'adjective', root: 'अनादि', gloss: 'without-beginning / beginningless (compound stem)' },
  'अनादिम्':        { category: 'adjective', root: 'अनादि', gender: 'm', number: 'eka', case: 'dvi', gloss: 'without-beginning (object)' },
  'अप्रमेय':        { category: 'adjective', root: 'अप्रमेय', gloss: 'immeasurable / unfathomable (compound stem)' },
  'अप्रमेयम्':      { category: 'adjective', root: 'अप्रमेय', gender: 'n', number: 'eka', case: 'pra', gloss: 'immeasurable' },
  'आद्य':           { category: 'adjective', root: 'आद्य', gloss: 'first / primary (compound stem)' },
  'आद्यं':          { category: 'adjective', root: 'आद्य', gender: 'n', number: 'eka', case: 'pra', gloss: 'first / primary' },
  'क्लैब्य':         { category: 'noun', root: 'क्लैब्य', gender: 'n', gloss: 'cowardice / unmanliness (compound stem)' },
  'क्लैब्यम्':       { category: 'noun', root: 'क्लैब्य', gender: 'n', number: 'eka', case: 'dvi', gloss: 'cowardice / unmanliness (Gītā 2.3, the WhatsApp verse)' },
  'क्षुद्र':         { category: 'adjective', root: 'क्षुद्र', gloss: 'petty / small (compound stem)' },
  'क्षुद्रम्':       { category: 'adjective', root: 'क्षुद्र', gender: 'n', number: 'eka', case: 'dvi', gloss: 'petty / small' },
  'भैक्ष्य':         { category: 'noun', root: 'भैक्ष्य', gender: 'n', gloss: 'food obtained by begging / alms (compound stem)' },
  'भैक्ष्यम्':       { category: 'noun', root: 'भैक्ष्य', gender: 'n', number: 'eka', case: 'dvi', gloss: 'food obtained by begging (Gītā 2.5)' },
  'प्राण':           { category: 'noun', root: 'प्राण', gender: 'm', gloss: 'breath / life-force (compound stem)' },
  'प्राणम्':         { category: 'noun', root: 'प्राण', gender: 'm', number: 'eka', case: 'dvi', gloss: 'breath / life (object)' },
  'प्राणाः':         { category: 'noun', root: 'प्राण', gender: 'm', number: 'bahu', case: 'pra', gloss: 'breaths / lives (pl)' },
  'आवृत्ति':        { category: 'noun', root: 'आवृत्ति', gender: 'f', gloss: 'return / recurrence (compound stem)' },
  'आवृत्तिं':       { category: 'noun', root: 'आवृत्ति', gender: 'f', number: 'eka', case: 'dvi', gloss: 'return / recurrence' },
  'अध्यात्म':       { category: 'noun', root: 'अध्यात्म', gender: 'n', gloss: 'pertaining-to-the-self / inner self (compound stem)' },
  'अध्यात्मं':      { category: 'noun', root: 'अध्यात्म', gender: 'n', number: 'eka', case: 'pra', gloss: 'pertaining to the inner self (Gītā 8.3)' },
  'अध्यात्मम्':     { category: 'noun', root: 'अध्यात्म', gender: 'n', number: 'eka', case: 'pra', gloss: 'pertaining to the inner self' },
  'जित':            { category: 'krdanta', kind: 'past-passive', root: '√जि', gloss: 'conquered / won (compound stem)' },
  'जितम्':          { category: 'krdanta', kind: 'past-passive', root: '√जि', gender: 'n', number: 'eka', case: 'pra', gloss: 'conquered / won' },
