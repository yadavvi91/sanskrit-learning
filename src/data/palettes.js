...
export const PALETTES = [
...

  {
    ...
    name: 'Press',
    group: 'cool-light',
    blurb: 'Newsprint × Making Software. Pure white page, near-black ink. Source Serif 4 body, system sans labels. Vercel blue (#0070f3) is the primary accent — tab-active, decoded cells, finite verbs, samāsa. NYT red (#c1272d) returns as the secondary register — vibhakti notes, kāraka rows. Two-colour editorial system.',
    swatches: ['#ffffff', '#0a0a0a', '#0070f3', '#c1272d', '#666666'],
    vars: {
      '--parchment':       '#ffffff',
